...
import com.example.justin.stormy.Weather.Current;
import com.example.justin.stormy.Weather.Day;
import com.example.justin.stormy.Weather.Forecast;
import com.example.justin.stormy.Weather.Hour;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void getForecast(double latitude, double longitude) {
        String apiKey = "388a08026c95908c7045a30dc56d54ce";
        ...
        if (isNetworkAvailable()) {
            ...
            call.enqueue(new Callback() { //puts it in the queue, so it just does it when it can
                @Override
